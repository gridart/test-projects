...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:40px;">Tung!</span><br /><br /><span style="font-size:15px;"><strong>Funksionet e lojes:</strong><br /><br />1. Terhiqe topin e madh.<br />2. Shtyp Mouse1 në prapavij.<br />3. Përsërite.<br />4. Argëtohu!<br /></span>';
